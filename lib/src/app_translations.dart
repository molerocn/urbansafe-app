...
class AppTranslations {
  static const Map<String, Map<String, String>> translations = {
    'es': {
      ...
      'risk_description_medium': 'Riesgo medio en la zona',
      'risk_description_low': 'Riesgo bajo en la zona',
      'risk_description_unknown': 'Riesgo desconocido',
      'score': 'Score',
    ...
    'en': {
      ...
      'risk_description_medium': 'Medium risk in the area',
      'risk_description_low': 'Low risk in the area',
      'risk_description_unknown': 'Unknown risk',
      'score': 'Score',
